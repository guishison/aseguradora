...
#Region " Search Methods "
        ...
        ''' </remarks>
        Public Function Search(ByVal Id As Long, ByVal ParamArray Relations() As [Enum]) As SEC.PerfilPersonal
            Dim BEObject As SEC.PerfilPersonal = Nothing

            Try
                Using DALObject As New DAL.PerfilPersonal
...
#Region " List Methods "
        ...
        ''' 	To get relationship objects, suply relationship enumetators
        ''' </remarks>
        Public Function Listar(ByVal Order As String, ByVal ParamArray Relations() As [Enum]) As List(Of SEC.PerfilPersonal)
            Try
                Dim BECollection As List(Of SEC.PerfilPersonal)
        ...
        Public Function ListFilter(PageIndex As Integer, PageSize As Integer, order As String, ByVal ParamArray Relations() As [Enum]) As List(Of SEC.PerfilPersonal)
            Try
                Dim BECollection As List(Of SEC.PerfilPersonal)
                Using DALObject As New DAL.PerfilPersonal
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function Listar(ByVal IdMaster As Long, ByVal ParamArray Relations() As [Enum]) As List(Of SEC.PerfilPersonal)
            Try
                Dim BECollection As List(Of SEC.PerfilPersonal)
...
#Region " Save Methods "
        ...
        Public Sub Guardar(ByRef BEObj As SEC.PerfilPersonal)
            Dim DALObject As DAL.PerfilPersonal = Nothing

            Me.ErrorCollection.Clear()

            If Me.Validar(BEObj) Then
                Try
                    DALObject = New DAL.PerfilPersonal
        ...
        ''' <remarks>
        ''' </remarks>
        Friend Function Validar(ByRef BEObj As SEC.PerfilPersonal) As Boolean
