...
Namespace Bitacora
    <Serializable>
    Partial Public Class BitacoraGeneral
        Inherits BCEntity
...
#Region " Search Methods "
        ...
        Public Function Search(ByVal Id As Int32, ByVal ParamArray Relaciones() As [Enum]) As BAS.BitacoraGeneral
            Dim BEObject As BAS.BitacoraGeneral = Nothing

            Try
                Using DALObject As New DAL.BitacoraGeneral
...
#Region " List Methods "
        ...
        '    Try
        '        Dim BECollection As List(Of BAS.BitacoraGeneral)
        ...
        Public Function Listas(ByVal ParamArray Relaciones() As [Enum]) As List(Of BAS.BitacoraGeneral)
            Dim BECollection As List(Of BAS.BitacoraGeneral) = New List(Of BAS.BitacoraGeneral)
            'Dim DALObject As DAL.BitacoraGeneral = Nothing
            Me.ErrorCollection.Clear()
            Try
                Using DALObject = New DAL.BitacoraGeneral
            ...
            Return BECollection
        End Function
        Public Function Count(ByVal text As String, ByVal ParamArray Relations() As [Enum]) As List(Of BAS.BitacoraGeneral)
            Try
                Dim BECollection As List(Of BAS.BitacoraGeneral)
        ...
        Public Function Listar(ByVal buscar As String, ByVal estado As Int16, PageIndex As Int32, PageSize As Int32, ByVal ParamArray Relations() As [Enum]) As List(Of BAS.BitacoraGeneral)
            Dim BECollection As List(Of BAS.BitacoraGeneral) = New List(Of BAS.BitacoraGeneral)
            'Dim DALObject As DAL.BitacoraGeneral = Nothing
            Me.ErrorCollection.Clear()
            Try
        ...
        'Public Function List(ByVal Filter As String, ByVal Order As String, ByVal ParamArray Relaciones() As [Enum]) As List(Of BAS.BitacoraGeneral)
        '    Try
        '        Dim BECollection As List(Of BAS.BitacoraGeneral)
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function List(ByVal IdMaster As Int32, ByVal ParamArray Relaciones() As [Enum]) As List(Of BAS.BitacoraGeneral)
            Try
                Dim BECollection As List(Of BAS.BitacoraGeneral)
...
#Region " Save Methods "
        ...
        Public Sub Save(ByRef BEObj As BAS.BitacoraGeneral)
            ...
            If Me.Validate(BEObj) Then
                Try
                    DALObject = New DAL.BitacoraGeneral
        ...
        ''' <remarks>
        ''' </remarks>
        Friend Sub Save(ByRef colBEObj As List(Of BAS.BitacoraGeneral), ByVal IdMaster As Int32)
            Dim DALObject As DAL.BitacoraGeneral = Nothing
            Try
                DALObject = New DAL.BitacoraGeneral
                DALObject.OpenConnection()
        ...
        ''' <remarks>
        ''' </remarks>
        Friend Function Validate(ByRef BEObj As BAS.BitacoraGeneral) As Boolean
