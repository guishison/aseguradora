...
#Region " Save Methods"
        Public Sub Guardar(ByRef colBEObj As List(Of SEC.PlantillaDetalle))
            Dim strQuery As String = ""


            For Each BEobj As SEC.PlantillaDetalle In colBEObj
                ...
                Try
                    If BEobj.StatusType = BE.StatusType.Insert Then
                        strQuery = "[crm_seguridad_plantilladetalle_insert]"
                    ElseIf BEobj.StatusType = BE.StatusType.Update Then
                        ...
                        '"WHERE Id = @Id"
                        strQuery = "[crm_seguridad_plantilladetalle_update]"
                    ...
                    If BEobj.StatusType <> BE.StatusType.NoAction Then
                        ...
                        If (BEobj.StatusType <> BE.StatusType.Delete) Then
                            ...
                            MyBase.DBFactory.AddInParameter(MyBase.Command, "@PlanillaId", DbType.Int32, BEobj.PlantillaId)
...
#Region " Methods "
        ...
        ''' <remarks>
        ''' </remarks>
        Friend Function ReturnMaster(ByVal Id As Long, ByVal ParamArray Relaciones() As [Enum]) As SEC.PlantillaDetalle
        ...
        ''' <remarks>
        ''' </remarks>
        Friend Function ReturnChild(ByVal Keys As IEnumerable(Of Int32), ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.PlantillaDetalle)
            Dim llaves As String = MyBase.KeysArray(Keys).ToString.Replace("(", "(',")
            llaves = llaves.Replace(")", ",')")
            Dim strQuery As String = "crm_seguridad_plantilla_buscardetalles"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@llaves", DbType.String, llaves)
                Dim Coleccion As List(Of SEC.PlantillaDetalle) = MyBase.SQLConvertidorIDataReaderListas(Of SEC.PlantillaDetalle)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
        ...
        Protected Overrides Function LoadBE(Of T As BE.BEntity)(ByRef DR As IDataReader) As T
            Dim BEObject As New SEC.PlantillaDetalle
            ...
            With DR
                ...
                If Not .IsDBNull(3) Then
                    BEObject.PlantillaId = .GetInt32(3)
                End If
        ...
        ''' <remarks></remarks>
        Protected Sub CargarRelaciones(ByRef Coleccion As List(Of SEC.PlantillaDetalle), ByVal ParamArray Relaciones() As [Enum])
        ...
        ''' <param name="Relaciones">Relacioneship enumerator</param>
        ''' <remarks></remarks>
        Protected Sub CargarRelaciones(ByRef BEModulo As SEC.PlantillaDetalle, ByVal ParamArray Relaciones() As [Enum])
            Dim DALFormulario As Formulario
...
#Region " List Methods "
        ...
        Public Function Listar(ByVal Order As String, ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.PlantillaDetalle)
            ...
            Dim Coleccion As List(Of SEC.PlantillaDetalle) = MyBase.SQLList(Of SEC.PlantillaDetalle)(strQuery)
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function Listar(ByVal IdPadre As Long, ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.PlantillaDetalle)
...
#Region " Search Methods "
        ...
        Public Function Buscar(ByVal Id As Long, ByVal ParamArray Relaciones() As [Enum]) As SEC.PlantillaDetalle
            ...
            Dim BEModulo As SEC.PlantillaDetalle = MyBase.SQLSearch(Of SEC.PlantillaDetalle)(strQuery)
        ...
        Public Function BuscarPrivilegioPorPersonal(ByVal PlantillaId As Int32, ByVal FormularioId As Int32, ByVal UnidadNegocioId As Int32, ByVal ParamArray Relaciones() As [Enum]) As SEC.PlantillaDetalle
            Dim strQuery As String = "crm_seguridad_plantilladetalle_buscarporplantilla"

            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@PlantillaId", DbType.String, PlantillaId)
                ...
                Dim Collection As SEC.PlantillaDetalle = MyBase.SQLConvertidorIDataReader(Of SEC.PlantillaDetalle)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
        ...
        Public Function BuscarByPlantilla(ByVal Id As Int32) As List(Of SEC.PlantillaDetalle)
            Dim strQuery As String = "select * from crm_seguridad_plantilladetalle WHERE PlanillaId = " & Id & " and Estado = 1"
            Dim BEModulo As List(Of SEC.PlantillaDetalle) = MyBase.SQLList(Of SEC.PlantillaDetalle)(strQuery)
