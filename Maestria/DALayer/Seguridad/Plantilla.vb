...
#Region " Save Methods"
        ...
        Public Sub Guardar(ByRef BEObj As SEC.Plantilla)
            ...
            If BEObj.StatusType = BE.StatusType.Insert Then
                strQuery = "crm_seguridad_plantilla_insert"
            ElseIf BEObj.StatusType = BE.StatusType.Update Then
                strQuery = "crm_seguridad_plantilla_update"
...
#Region " Methods "
        ...
        ''' <remarks>
        ''' </remarks>
        Friend Function ReturnMaster(ByVal Id As Long, ByVal ParamArray Relaciones() As [Enum]) As SEC.Plantilla
        ...
        Friend Function ReturnChild(ByVal Keys As IEnumerable(Of Int32), ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.Plantilla)
            Dim strQuery As String = "SELECT * FROM security_msprofile WHERE UserId IN " & MyBase.KeysArray(Keys)
            Dim Coleccion As List(Of SEC.Plantilla) = Nothing
            Coleccion = MyBase.SQLList(Of SEC.Plantilla)(strQuery)
        ...
        Friend Function ReturnChild3(ByVal Keys As IEnumerable(Of Int32), ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.Plantilla)
        ...
        Friend Function ReturnChildById(ByVal Keys As IEnumerable(Of Int32), ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.Plantilla)
        ...
        Friend Function ReturnChild2(ByVal Keys As IEnumerable(Of Int32), ByVal ParamArray Relaciones() As [Enum]) As SEC.Plantilla
            Dim strQuery As String = "SELECT * FROM security_msprofile WHERE Id IN " & MyBase.KeysArray(Keys)
            Dim BEProfile As SEC.Plantilla = Nothing
            BEProfile = MyBase.SQLSearch(Of SEC.Plantilla)(strQuery)
        ...
        ''' <remarks></remarks>
        Protected Sub CargarRelaciones(ByRef Coleccion As List(Of SEC.Plantilla), ByVal ParamArray Relaciones() As [Enum])
        ...
        ''' <param name="Relaciones">Relacioneship enumerator</param>
        ''' <remarks></remarks>
        Protected Sub CargarRelaciones(ByRef BEProfile As SEC.Plantilla, ByVal ParamArray Relaciones() As [Enum])
            Dim DALFormulario As Formulario
            Dim DALPersonal As Personal
            Dim DalPlantillaDetalle As PlantillaDetalle
            'Dim DALDetallePlantilla As PlantillaDetalle
            ...
            For Each RelationEnum As [Enum] In Relaciones
                ...
                End If
                'If RelationEnum.Equals(SEC.relPlanilla.PlantillaDetalle) Then
                '    DALDetallePlantilla = New PlantillaDetalle(True, CType(MyBase.DBFactory, Object))
                '    BEProfile.ColeccionPlantillaDetalle = DALDetallePlantilla.Listar(BEProfile.Id, Relaciones)
                'End If
                If RelationEnum.Equals(SEC.relPlanilla.PlantillaDetalle) Then
                    DalPlantillaDetalle = New PlantillaDetalle(True, CType(MyBase.DBFactory, Object))
                    BEProfile.ColeccionPlantillaDetalle = DalPlantillaDetalle.BuscarByPlantilla(BEProfile.Id)
                End If
...
#Region " List Methods "
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function Listar(ByVal Nombre As String, ByVal UnidadNegocioPadreId As Int32, ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.Plantilla)
            Dim strQuery As String = "crm_seguridad_plantilla_lista"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@Nombre", DbType.String, Nombre)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@UnidadNegocioPadreId", DbType.String, UnidadNegocioPadreId)
                Dim Collection As List(Of SEC.Plantilla) = MyBase.SQLConvertidorIDataReaderListas(Of SEC.Plantilla)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                Return Collection
            Catch ex As Exception
                MyBase.ErrorHandler(ex, ErrorPolicy.DALWrap)
                Return Nothing
        ...
        Public Function PagedFilterList(PageIndex As Integer, PageSize As Integer, OrderBy As String, ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.Plantilla)
            Dim strQuery As String = "SELECT * FROM security_msprofile Order By " & OrderBy
            Dim Coleccion As List(Of SEC.Plantilla) = MyBase.PaggingSQLList(Of SEC.Plantilla)(strQuery, PageIndex, PageSize)
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function Listar(ByVal IdPadre As Long, ByVal ParamArray Relaciones() As [Enum]) As List(Of SEC.Plantilla)
            Dim strQuery As String = "SELECT * FROM security_msprofile WHERE IdPadre = " & IdPadre.ToString
            Dim Coleccion As List(Of SEC.Plantilla) = MyBase.SQLList(Of SEC.Plantilla)(strQuery)
        ...
        Friend Function ReturnOption(ByVal Keys As IEnumerable(Of Int32), ByVal ParamArray Relaciones() As [Enum]) As List(Of BE.Relation)
            Dim strQuery As String = "SELECT IT.* FROM security_psprofileoption IT INNER JOIN " &
                                         "security_msprofile A ON A.Id = IT.PlantillaId WHERE IT.PlantillaId in " & MyBase.KeysArray(Keys)
...
#Region " Search Methods "
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function Buscar(ByVal Id As Long, ByVal ParamArray Relaciones() As [Enum]) As SEC.Plantilla
            Dim strQuery As String = "crm_seguridad_plantilla_buscarid"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@Id", DbType.Int32, Id)
                Dim Collection As SEC.Plantilla = MyBase.SQLConvertidorIDataReader(Of SEC.Plantilla)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
            ...
            End Try
        End Function
        Public Function Existe(ByVal NombrePlantilla As String, ByVal ParamArray Relaciones() As [Enum]) As SEC.Plantilla
            Dim strQuery As String = "crm_seguridad_plantilla_existencia"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@Nombre", DbType.String, NombrePlantilla)
                Dim Collection As SEC.Plantilla = MyBase.SQLConvertidorIDataReader(Of SEC.Plantilla)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                If Collection IsNot Nothing Then
                    Me.CargarRelaciones(Collection, Relaciones)
                End If
