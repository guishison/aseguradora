...
#Region " Save Methods"
        ...
        ''' <remarks>
        ''' </remarks>
        Public Sub Guardar(ByRef BEObj As MEB.Region)

            Dim strQuery As String = ""

            If BEObj.StatusType = BE.StatusType.Insert Then
                strQuery = "crm_base_region_insert"
            ElseIf BEObj.StatusType = BE.StatusType.Update Then
                strQuery = "crm_base_region_update"
            ...
            Try
                If BEObj.StatusType <> BE.StatusType.NoAction Then
                    ...
                    MyBase.DBFactory.AddInParameter(MyBase.Command, "@PaisId", DbType.Int32, BEObj.PaisId)
        ...
        Public Sub Guardar(ByRef colBEObj As List(Of MEB.Region))

            Dim strQuery As String = ""
            For Each BEobj As MEB.Region In colBEObj
                If BEobj.StatusType = BE.StatusType.Insert Then
                    strQuery = "crm_base_region_insert"
                ElseIf BEobj.StatusType = BE.StatusType.Update Then
                    strQuery = "crm_base_region_update"
...
#Region " Methods "
        ...
        ''' <remarks>
        ''' </remarks>
        Friend Function ReturnMaster(ByVal Id As Int32, ByVal ParamArray Relations() As [Enum]) As MEB.Region
        ...
        Protected Overrides Function LoadBE(Of T As BE.BEntity)(ByRef DR As IDataReader) As T
            Dim BEObject As New MEB.Region

            With DR
                BEObject.Id = .GetInt32(0)
                BEObject.Nombre = .GetString(1)
                BEObject.PaisId = .GetInt32(2)
        ...
        ''' <remarks></remarks>
        Protected Sub LoadRelations(ByRef Collection As List(Of MEB.Region), ByVal ParamArray Relations() As [Enum])
            'Dim DALPais As Pais
        ...
        ''' <param name="Relations">Relationship enumerator</param>
        ''' <remarks></remarks>
        Protected Sub LoadRelations(ByRef BEInstanciaSala As MEB.Region, ByVal ParamArray Relations() As [Enum])
...
#Region " List Methods "
        ...
        Public Function List(ByVal Filter As String, ByVal Order As String, ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Region)
            Dim strQuery As String = "crm_base_region_lista"
            Dim Collection As List(Of MEB.Region) = MyBase.SQLList(Of MEB.Region)(strQuery)
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function List(ByVal IdPadre As Long, ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Region)
            ...
            Return Collection
        End Function
        Public Function List(ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Region)
            Dim strQuery As String = "crm_base_region_listado"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                Dim Collection As List(Of MEB.Region) = MyBase.SQLConvertidorIDataReaderListas(Of MEB.Region)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                Return Collection
            Catch ex As Exception
                MyBase.ErrorHandler(ex, ErrorPolicy.DALWrap)
                Return Nothing
            ...
            End Try
        End Function
        Public Function ListPorIdPais(ByVal IdPais As Int32, ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Region)
            Dim strQuery As String = "crm_base_region_listaporpais"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@IdPais", DbType.Int32, IdPais)
                Dim Collection As List(Of MEB.Region) = MyBase.SQLConvertidorIDataReaderListas(Of MEB.Region)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                If Collection.Count > 0 Then
...
#Region " Search Methods "
        ...
        ''' <remarks>
        ''' </remarks> 
        Public Function Search(ByVal Id As Int32, ByVal ParamArray Relations() As [Enum]) As MEB.Region
            Dim strQuery As String = "crm_base_region_buscarporid"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@Id", DbType.Int32, Id)
                Dim Collection As MEB.Region = MyBase.SQLConvertidorIDataReader(Of MEB.Region)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                Return Collection
            Catch ex As Exception
                MyBase.ErrorHandler(ex, ErrorPolicy.DALWrap)
                Return Nothing
            ...
            End Try
        End Function
        Public Function SearchIdPais(ByVal IDPais As Int32, ByVal ParamArray Relations() As [Enum]) As MEB.Region
            Dim strQuery As String = "crm_base_region_buscarporidpais"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@IDPais", DbType.Int32, IDPais)
                Dim Collection As MEB.Region = MyBase.SQLConvertidorIDataReader(Of MEB.Region)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
            ...
            End Try
        End Function
        Public Function SearchActiva(ByVal Id As Int32, ByVal Estado As Int16, ByVal ParamArray Relations() As [Enum]) As MEB.Region
            Dim strQuery As String = "crm_base_region_buscarporidActiva"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@Id", DbType.Int32, Id)
