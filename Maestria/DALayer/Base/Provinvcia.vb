...
#Region " Save Methods"
        ...
        ''' <remarks>
        ''' </remarks>
        Public Sub Guardar(ByRef BEObj As MEB.Provincia)

            Dim strQuery As String = ""

            If BEObj.StatusType = BE.StatusType.Insert Then
                strQuery = "crm_base_provincia_insert"
            ElseIf BEObj.StatusType = BE.StatusType.Update Then
                strQuery = "crm_base_provincia_update"
            ...
            Try
                If BEObj.StatusType <> BE.StatusType.NoAction Then
                    ...
                    MyBase.DBFactory.AddInParameter(MyBase.Command, "@RegionId", DbType.Int32, BEObj.RegionId)
        ...
        Public Sub Guardar(ByRef colBEObj As List(Of MEB.Provincia))

            Dim strQuery As String = ""
            For Each BEobj As MEB.Provincia In colBEObj
                If BEobj.StatusType = BE.StatusType.Insert Then
                    strQuery = "crm_base_provincia_insert"
                ElseIf BEobj.StatusType = BE.StatusType.Update Then
                    strQuery = "crm_base_provincia_update"
...
#Region " Methods "
        ...
        ''' <remarks>
        ''' </remarks>
        Friend Function ReturnMaster(ByVal Id As Int32, ByVal ParamArray Relations() As [Enum]) As MEB.Provincia
            Return Search(Id, Relations)
        End Function

        ''' <summary>
        ''' 	Devuelve un objeto InstanciaSala de tipo uno a uno con otro objeto
        ''' </summary>
        ''' <param name="Keys">Los identificadores de los objetos relacionados a InstanciaSala</param>
        ''' <param name="Relations">Enumerador de Relations a retorar</param>
        ''' <returns>Un Objeto de tipo InstanciaSala</returns>
        ''' <remarks>
        ''' </remarks> 
        ...
        Protected Overrides Function LoadBE(Of T As BE.BEntity)(ByRef DR As IDataReader) As T
            Dim BEObject As New MEB.Provincia
        ...
        ''' <remarks></remarks>
        Protected Sub LoadRelations(ByRef Collection As List(Of MEB.Provincia), ByVal ParamArray Relations() As [Enum])
            'Dim DALPais As Pais
        ...
        ''' <param name="Relations">Relationship enumerator</param>
        ''' <remarks></remarks>
        Protected Sub LoadRelations(ByRef BEInstanciaSala As MEB.Provincia, ByVal ParamArray Relations() As [Enum])
            Dim DAlRegion As Region

            For Each RelationEnum As [Enum] In Relations
                If RelationEnum.Equals(MEB.relProvincia.Region) Then
                    DAlRegion = New Region(True, CType(MyBase.DBFactory, Object))
                    BEInstanciaSala.Region = DAlRegion.ReturnMaster(BEInstanciaSala.RegionId, Relations)
                End If
...
#Region " List Methods "
        ...
        Public Function List(ByVal Filter As String, ByVal Order As String, ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Provincia)
            Dim strQuery As String = "crm_base_provincia_lista"
            Dim Collection As List(Of MEB.Provincia) = MyBase.SQLList(Of MEB.Provincia)(strQuery)
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function List(ByVal IdPadre As Long, ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Provincia)
        ...
        Public Function List(ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Provincia)
            Dim strQuery As String = "crm_base_provincia_listado"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                Dim Collection As List(Of MEB.Provincia) = MyBase.SQLConvertidorIDataReaderListas(Of MEB.Provincia)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                Return Collection
            Catch ex As Exception
                MyBase.ErrorHandler(ex, ErrorPolicy.DALWrap)
                Return Nothing
...
#Region " Search Methods "
        ...
        Public Function Search(ByVal Id As Int32, ByVal ParamArray Relations() As [Enum]) As MEB.Provincia
            Dim strQuery As String = "crm_base_provincia_buscarporid"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@Id", DbType.Int32, Id)
                Dim Collection As MEB.Provincia = MyBase.SQLConvertidorIDataReader(Of MEB.Provincia)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
        ...
        Public Function SearchIdRegion(ByVal IdRegion As Int32, ByVal ParamArray Relations() As [Enum]) As MEB.Provincia
            Dim strQuery As String = "crm_base_provincia_buscarporidregion"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@IdRegion", DbType.Int32, IdRegion)
                Dim Collection As MEB.Provincia = MyBase.SQLConvertidorIDataReader(Of MEB.Provincia)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
        ...
        Public Function SearchActiva(ByVal Id As Int32, ByVal Estado As Int16, ByVal ParamArray Relations() As [Enum]) As MEB.Provincia
            Dim strQuery As String = "crm_base_provincia_buscarporidActiva"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@Id", DbType.Int32, Id)
