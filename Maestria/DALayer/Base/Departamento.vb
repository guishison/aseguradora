...
#Region " Save Methods"
        ...
        ''' <remarks>
        ''' </remarks>
        Public Sub Guardar(ByRef BEObj As MEB.Departamento)

            Dim strQuery As String = ""
            If BEObj.StatusType = BE.StatusType.Insert Then
                strQuery = "crm_base_departamento_insert"
            ElseIf BEObj.StatusType = BE.StatusType.Update Then
                strQuery = "crm_base_departamento_update"
            ...
            Try
                If BEObj.StatusType <> BE.StatusType.NoAction Then
                    ...
                    MyBase.DBFactory.AddInParameter(MyBase.Command, "@DepartamentoSuperiorId", DbType.Int32, BEObj.DepartamentoSuperiorId)
        ...
        Public Sub Guardar(ByRef colBEObj As List(Of MEB.Departamento))

            Dim strQuery As String = ""
            For Each BEobj As MEB.Departamento In colBEObj
                If BEobj.StatusType = BE.StatusType.Insert Then
                    strQuery = "crm_base_departamento_insert"
                ElseIf BEobj.StatusType = BE.StatusType.Update Then
                    strQuery = "crm_base_departamento_update"
...
#Region " Methods "
        ...
        Protected Overrides Function LoadBE(Of T As BE.BEntity)(ByRef DR As IDataReader) As T
            Dim BEObject As New MEB.Departamento

            With DR
                BEObject.Id = .GetInt32(0)
                BEObject.Nombre = .GetString(1)
                BEObject.DepartamentoSuperiorId = .GetInt32(2)
        ...
        ''' <remarks></remarks>
        Protected Sub LoadRelations(ByRef Collection As List(Of MEB.Departamento), ByVal ParamArray Relations() As [Enum])
        ...
        ''' <remarks></remarks>
        Protected Sub LoadRelations(ByRef BEInstanciaSala As MEB.Departamento, ByVal ParamArray Relations() As [Enum])
...
#Region " List Methods "
        ...
        Public Function List(ByVal Text As String, ByVal Estado As Int16, ByVal CantidadRegistros As Int32, ByVal NumeroPagina As Int32, ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Departamento)
            Dim strQuery As String = "crm_base_departamento_list"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                ...
                Dim Collection As List(Of MEB.Departamento) = MyBase.SQLConvertidorIDataReaderListas(Of MEB.Departamento)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                Return Collection
            Catch ex As Exception
                MyBase.ErrorHandler(ex, ErrorPolicy.DALWrap)
                Return Nothing
            ...
            End Try
        End Function
        Public Function List(ByVal Filter As String, ByVal Order As String, ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Departamento)
            Dim strQuery As String = "crm_base_departamento_lista"
            Dim Collection As List(Of MEB.Departamento) = MyBase.SQLList(Of MEB.Departamento)(strQuery)
        ...
        ''' <remarks>
        ''' </remarks>
        Public Function List(ByVal IdPadre As Long, ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Departamento)
            ...
            Return Collection
        End Function
        Public Function List(ByVal ParamArray Relations() As [Enum]) As List(Of MEB.Departamento)
            Dim strQuery As String = "crm_base_departamento_listado"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                Dim Collection As List(Of MEB.Departamento) = MyBase.SQLConvertidorIDataReaderListas(Of MEB.Departamento)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                Return Collection
...
#Region " Search Methods "
        ...
        ''' <remarks>
        ''' </remarks> 
        Public Function Search(ByVal Id As Int32, ByVal ParamArray Relations() As [Enum]) As MEB.Departamento
            Dim strQuery As String = "crm_base_departamento_buscarporid"
            Try
                MyBase.Command = MyBase.DBFactory.GetStoredProcCommand(strQuery)
                MyBase.DBFactory.AddInParameter(MyBase.Command, "@Id", DbType.Int32, Id)
                Dim Collection As MEB.Departamento = MyBase.SQLConvertidorIDataReader(Of MEB.Departamento)(MyBase.DBFactory.ExecuteReader(MyBase.Command))
                Return Collection
            Catch ex As Exception
                MyBase.ErrorHandler(ex, ErrorPolicy.DALWrap)
                Return Nothing
