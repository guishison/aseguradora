<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/assets/master/MasterPage.Master" CodeBehind="ParametroLogin.aspx.vb" Inherits="Afiliacion2.ParametroLogin" %>
                            ...
                            <div class="dataTables_wrapper form-inline" role="grid">
                                <telerik:RadGrid ID="rgvGrid" runat="server" CssClass="table-responsive" AutoGenerateColumns="False" GridLines="None" AllowPaging="True" CellSpacing="0" VirtualItemCount="5" PageSize="10" Skin="Bootstrap">
                                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="Id" AllowCustomPaging="false" AllowPaging="true">
                                        <Columns>
                                            <telerik:GridTemplateColumn HeaderText="Acciones" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <div class="btn-group btn-group-xs" role="group">
                                                        <telerik:RadButton ID="btnEdit" CommandName="EditProvider" runat="server" ToolTip="Modificar" AutoPostBack="true" Skin="Bootstrap" OnClientClicking="OnEditProvider">
                                                            <Icon PrimaryIconCssClass="fa fa-pencil" PrimaryIconLeft="15px" PrimaryIconTop="6px" />
                                                        </telerik:RadButton>
                                                        <telerik:RadButton ID="btnDelete" CommandName="DeleteProvider" runat="server" ToolTip="Eliminar" AutoPostBack="true" Skin="Bootstrap" OnClientClicking="ConfirmDelete">
                                                            <Icon PrimaryIconCssClass="fa fa-trash-o" PrimaryIconLeft="15px" PrimaryIconTop="6px" />
                                                        </telerik:RadButton>
                                                    </div>
                                                </ItemTemplate>
                                            ...
                                            <telerik:GridBoundColumn DataField="LongitudMaxima" HeaderText="Longitud Máxima" UniqueName="LongitudMaxima" />
                                            <telerik:GridBoundColumn DataField="LongitudMinima" HeaderText="Longitud Mínima" UniqueName="LongitudMinima" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridBoundColumn DataField="Nivel.Nombre" HeaderText="Nivel Password" UniqueName="NivelPassword" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridBoundColumn DataField="NombreExpiracion" HeaderText="Expiracion" UniqueName="Expiracion" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridBoundColumn DataField="CantidadIntentosFallidos" HeaderText="Cantidad Intentos Fallidos" UniqueName="CantidadIntentosFallidos" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridBoundColumn DataField="TiempoBloqueo" HeaderText="Tiempo Bloqueo" UniqueName="TiempoBloqueo" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridBoundColumn DataField="ComprobacionesPasswordAnteriores" HeaderText="Comparaciones Password Anteriores" UniqueName="ComprobacionesPasswordAnteriores" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridBoundColumn DataField="NombreEstado" HeaderText="Estado" UniqueName="Estado" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridBoundColumn DataField="FechaRegistro" HeaderText="Fecha" UniqueName="Fecha" DataType="System.DateTime" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" HeaderStyle-HorizontalAlign="Center" />
                                        </Columns>
                                        <NoRecordsTemplate>
