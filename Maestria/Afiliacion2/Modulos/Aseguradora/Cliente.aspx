<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/assets/master/MasterPage.Master" CodeBehind="Cliente.aspx.vb" Inherits="Afiliacion2.Cliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form" runat="server">
                                ...
                                <telerik:RadGrid ID="rgvGrid" CssClass="table-responsive" runat="server" AutoGenerateColumns="False" GridLines="None" AllowPaging="True" VirtualItemCount="15" CellSpacing="0" PageSize="15" Skin="Bootstrap">
                                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="Id" AllowCustomPaging="true" AllowPaging="true" TableLayout="Fixed">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Apellido" HeaderText="Apellido" UniqueName="Apellido" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="CI" HeaderText="CI" UniqueName="CI" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Expedido.Nombre" HeaderText="Expedido" UniqueName="Expedido" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Telefono" HeaderText="Telefono" UniqueName="Telefono" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="FechaNacimiento" HeaderText="Fecha Nacimiento" UniqueName="FechaNacimiento" DataType="System.DateTime" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Direccion" HeaderText="Direccion" UniqueName="Direccion" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                        </Columns>
                                        <NoRecordsTemplate>
        ...
        <div id="divDetail" class="dialog" style="display: none">
            <asp:Panel ID="paDetail" runat="server" CssClass="MinWidth467 MaxWidth560">
                <table style="width: 100%">
                    <tr>
                        <td class="negrita">Nombre:
                        </td>
                        <td colspan="2">
                            <telerik:RadTextBox ID="rtbNombre" runat="server" EmptyMessage="Ingrese el nombre" CssClass="combo100porc"  Skin="Bootstrap">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="negrita">Apellido:
                        </td>
                        <td colspan="2">
                            <telerik:RadTextBox ID="rtbApellido" runat="server" EmptyMessage="Ingrese los apellidos" CssClass="combo100porc"  Skin="Bootstrap">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="negrita combo20porc">CI:
                        </td>
                        <td class="combo60porc">
                            <telerik:RadNumericTextBox ID="rntCI" runat="server" EmptyMessage="Ingrese el numero de CI"  ClientEvents-OnBlur="Onblur" NumberFormat-DecimalDigits="0" NumberFormat-GroupSeparator="" MinValue="0"  CssClass="combo100porc"  Skin="Bootstrap">
                            </telerik:RadNumericTextBox>
                        </td>
                        <td class="combo20porc">                            
                            <telerik:RadComboBox ID="rcbExpedido" runat="server" CssClass="combo100porc" OnClientKeyPressing="radComboKeyPress" MaxHeight="150" EnableTextSelection="true" MarkFirstMatch="true" DropDownAutoWidth="Enabled" Filter="Contains" Skin="Bootstrap">
                            </telerik:RadComboBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="negrita">Telefono:
                        </td>
                        <td colspan="2">
                            <telerik:RadNumericTextBox ID="rntTelefono" runat="server" CssClass="combo100porc" EmptyMessage="Ingrese un numero de telefono" ClientEvents-OnBlur="Onblur" NumberFormat-GroupSeparator="" NumberFormat-DecimalDigits="0" MinValue="0" Skin="Bootstrap">
                            </telerik:RadNumericTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="negrita">Fecha Nac:
                        </td>
                        <td colspan="2">
                            <telerik:RadDatePicker runat="server" ID="rdpFechaNacimiento" CssClass="combo100porc" Skin="Bootstrap"></telerik:RadDatePicker>
                        </td>
                    </tr>
                    <tr>
                        <td class="negrita">Dirección:
                        </td>
                        <td colspan="2">
                            <telerik:RadTextBox ID="rtbDireccion" runat="server" CssClass="combo100porc" TextMode= "MultiLine" Rows="7" Skin="Bootstrap">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
