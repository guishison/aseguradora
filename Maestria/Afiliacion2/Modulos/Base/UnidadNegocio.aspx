<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/assets/master/MasterPage.Master" CodeBehind="UnidadNegocio.aspx.vb" Inherits="Afiliacion2.UnidadNegocio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <h1>Concesionarias
                <small>Registro de Concesionarias.</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Inicio</a></li>
            <li><a href="#"><i class="fa fa-dashboard"></i>Aseguradora</a></li>
            <li class="active">Concesionarias</li>
        </ol>
    </section>
                                ...
                                <telerik:RadGrid ID="rgvGrid" CssClass="table-responsive" runat="server" AutoGenerateColumns="False" GridLines="None" AllowPaging="True" VirtualItemCount="15" CellSpacing="0" PageSize="15" Skin="Bootstrap">
                                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="Id" AllowCustomPaging="true" AllowPaging="true" TableLayout="Fixed">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="Correlativo" HeaderText="Correlativo" UniqueName="Correlativo" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="AliasUN" HeaderText="Alias" UniqueName="Alias" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="UnidadNegocio.Nombre" HeaderText="Unidad de Negocio" UniqueName="Potencia" HeaderStyle-HorizontalAlign="Center"></telerik:GridBoundColumn>
                                        </Columns>
                                        <NoRecordsTemplate>
        ...
        <div id="divDetail" class="dialog" style="display: none">
            <asp:Panel ID="paDetail" runat="server" CssClass="MinWidth467">
                <table style="width: 100%">
                    <tr>
                        <td class="negrita">Unidad Negocio:
                        </td>
                        <td>
                            <telerik:RadComboBox ID="rcbUnidadNegocio" runat="server" CssClass="combo100porc" OnClientKeyPressing="radComboKeyPress" MaxHeight="150" EnableTextSelection="true" MarkFirstMatch="true" DropDownAutoWidth="Enabled" Filter="Contains" Skin="Bootstrap">
                            </telerik:RadComboBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox ID="rtbNombre" runat="server" CssClass="combo100porc" EmptyMessage="Nombre de la concesionaria" Skin="Bootstrap">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="negrita">Correlativo:
                        </td>
                        <td>
                            <telerik:RadNumericTextBox ID="rntCorrelativo"  runat="server" CssClass="combo100porc" ClientEvents-OnBlur="Onblur" NumberFormat-DecimalDigits="0" MinValue="0" NumberFormat-GroupSeparator="" Skin="Bootstrap">
                            </telerik:RadNumericTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="negrita">Alias:
                        </td>
                        <td>
                            <telerik:RadTextBox ID="rtbAlias" runat="server" CssClass="combo100porc" EmptyMessage="Escriba un alias de la concesionaria" Skin="Bootstrap">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <script type="text/javascript" src="Scripts/UnidadNegocio.js"></script>
</asp:Content>
