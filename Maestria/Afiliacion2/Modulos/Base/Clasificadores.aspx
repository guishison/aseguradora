<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/assets/master/MasterPage.Master" CodeBehind="Clasificadores.aspx.vb" Inherits="Afiliacion2.Clasificadores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="content-header">
        <h1>Clasificadores
                <small>Especificaciones de configuraciones globales del sistema</small>
        </h1>
        <ol class="breadcrumb">
...
<form id="form" runat="server">
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="AjustarPanel();" UpdatePanelsRenderMode="Inline">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="rcbTipoClasifica">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rgvGrid" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Lista de clasificadores
                                <br />
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-md-push-1">
                                    <div class="col-md-4">
                                            <telerik:RadComboBox ID="rcbTipoClasifica" runat="server" CssClass="combo100porc" Skin="Bootstrap" AutoPostBack="true" OnClientKeyPressing="radComboKeyPress" MaxHeight="150" EnableTextSelection="true" MarkFirstMatch="true" DropDownAutoWidth="Enabled" Filter="Contains">
                                            </telerik:RadComboBox>
                                        </div>
                                    <div class="col-md2-7">
                                        <div class="input-group">
                                            <telerik:RadTextBox ID="rtbFilter" runat="server" Skin="Bootstrap" Placeholder="Ingrese el nombre del clasificador">
                            ...
                            <div class="dataTables_wrapper form-inline" role="grid">
                                <telerik:RadGrid ID="rgvGrid" runat="server" CssClass="table-responsive" AutoGenerateColumns="false" GridLines="None" AllowCustomPaging="true" AllowPaging="true" VirtualItemCount="5" CellSpacing="0" Skin="Bootstrap" PageSize="20">
                                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="Id">
                                        <Columns>
                                            ...
                                            <telerik:GridDateTimeColumn DataField="Nombre" HeaderText="Nombre" UniqueName="NombreTipo" DataType="System.String" HeaderStyle-HorizontalAlign="Left" />
                                            <telerik:GridDateTimeColumn DataField="Valor" HeaderText="Valor" UniqueName="Valor" DataType="System.String" HeaderStyle-HorizontalAlign="Left" />
                                            <telerik:GridDateTimeColumn DataField="ClasificadoresTipo.Nombre" HeaderText="Tipo clasificador" UniqueName="ClasificadoresTipo.Nombre" DataType="System.String" HeaderStyle-HorizontalAlign="Left" />
                                        </Columns>
                                        <NoRecordsTemplate>
        ...
        <div id="divDetail" class="dialog" style="display: none;">
            <asp:Panel ID="paDetail" runat="server" CssClass="MinWidth467">
                <table style="width: 100%">
                    <tr>
                        <td>Tipo clasificador:
                        </td>
                        <td>
                            <telerik:RadComboBox ID="rcbTipoClasificador" CssClass="combo100porc" runat="server" Placeholder="Seleccione aqui" Skin="Bootstrap" OnClientKeyPressing="radComboKeyPress" MaxHeight="150" EnableTextSelection="true" MarkFirstMatch="true" DropDownAutoWidth="Enabled" Filter="Contains" />
                        </td>
                    </tr>
                    <tr>
                        <td>Nombre:
                        ...
                        <td>
                            <telerik:RadTextBox ID="rtbNombre" runat="server" CssClass="combo100porc" Placeholder="Nombre" Skin="Bootstrap" />
                        </td>
                    </tr>
                    <tr>
                        <td>Valor:
                        ...
                        <td>
                            <telerik:RadTextBox ID="rtbValor" runat="server" CssClass="combo100porc" Placeholder="Valor" Skin="Bootstrap" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <script type="text/javascript" src="Scripts/Clasificadores.js"></script>
</asp:Content>
