...
Partial Public Class CargoJerarquia
    ...
    '''<summary>
    '''Control rtbDescription.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents rtbDescription As Global.Telerik.Web.UI.RadTextBox
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents rcbParent As Global.Telerik.Web.UI.RadComboBox
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents rnbBaseFee As Global.Telerik.Web.UI.RadNumericTextBox
