...
Partial Public Class UnidadNegocio
    ...
    '''<summary>
    '''Control rcbUnidadNegocio.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents rcbUnidadNegocio As Global.Telerik.Web.UI.RadComboBox
    ...
    '''<summary>
    '''Control rntCorrelativo.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents rntCorrelativo As Global.Telerik.Web.UI.RadNumericTextBox
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents rtbAlias As Global.Telerik.Web.UI.RadTextBox
